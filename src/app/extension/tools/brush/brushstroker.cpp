...
void FSPenStroker::drawFirst(const TabletInputData &data)
{
	_radiusPrev = 0;
	_posPrev = data.pos;
...
void FSBrushStroker::drawFirst(const TabletInputData &data)
{
	_carryOver = 1;
	drawDab(data);
}
...
void FSBrushStroker::drawDab(const TabletInputData &data)
{
