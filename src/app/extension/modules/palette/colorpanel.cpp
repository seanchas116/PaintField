	...
	QWidget(parent)
{
	...
	PaletteManager *pmanager = PaletteModule::paletteManager();
	
	connect(_colorWheel, SIGNAL(colorChanged(MLColor)), pmanager, SLOT(setColor(MLColor)));
	connect(_sliderPanel, SIGNAL(colorChanged(MLColor)), pmanager, SLOT(setColor(MLColor)));
	connect(_webColorPanel, SIGNAL(colorChanged(MLColor)), pmanager, SLOT(setColor(MLColor)));
	
	connect(pmanager, SIGNAL(currentColorChanged(MLColor)), _colorWheel, SLOT(setColor(MLColor)));
	connect(pmanager, SIGNAL(currentColorChanged(MLColor)), _sliderPanel, SLOT(setColor(MLColor)));
	connect(pmanager, SIGNAL(currentColorChanged(MLColor)), _webColorPanel, SLOT(setColor(MLColor)));
	
	connect(pmanager, SIGNAL(colorChanged(int,MLColor)), this, SLOT(setColor(int,MLColor)));
	connect(pmanager, SIGNAL(currentIndexChanged(int)), this, SLOT(setCurrentIndex(int)));
